...
public class MovieListingView extends Application {
    ...
    private VBox createHeader() {
        ...
        try {
            ...
            logo.setFitHeight(60);  // Adjust size as needed
    ...
    private void loadMovies() {
        ...
        loadMoviesTask.setOnSucceeded(event -> {
            cachedMovies = loadMoviesTask.getValue(); // Cache the movies
            displayMovies(cachedMovies);
    ...
    //     // Main container
    //     mainLayout = new BorderPane();  // Remove the local variable declaration
    //     mainLayout.setStyle("-fx-background-color: " + DARK_BACKGROUND + ";");
    ...
    private void handleBooking(Movie movie) {
        ...
        MovieDetailView detailView = new MovieDetailView(movie, this);
